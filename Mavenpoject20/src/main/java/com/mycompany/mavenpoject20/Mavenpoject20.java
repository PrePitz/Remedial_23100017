...
public class Mavenpoject20 extends JFrame implements Runnable {
    ...
    private void initializeUI() {
        ...
        bannerLabel.setForeground(new Color(200, 0, 0)); // Warna hijau tua
        ...
        manageProductsButton.setBackground(new Color(70, 130, 180)); 
        manageProductsButton.setForeground(Color.BLACK);
        ...
        sellProductsButton.setBackground(new Color(70, 130, 180)); 
        sellProductsButton.setForeground(Color.BLACK);
        ...
        manageCustomersButton.setBackground(new Color(70, 130, 180)); 
        manageCustomersButton.setForeground(Color.BLACK);
